...
function dataGetter() {
    const elems = Array.from(document.querySelectorAll('.form-box input, .form-box textarea, .form-box select'));
    const data = {};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.form-box input, .form-box textarea, .form-box select').forEach(el => {
